(function(){
  ...
  function productCard(p){return `
    <article class="product-card card">
      ...
      <div class="product-actions"><button class="small-btn" data-add-cart="${p.id}">Add to cart</button><a class="secondary-btn" href="${url('shopping-cart/')}">View cart</a></div>
    </article>`}
  ...
  const layouts = {
      ...
      <section class="hero">
        <div class="hero-grid">
          <div>
            ...
            <div class="hero-actions"><a class="primary-btn" href="${url('shopping-cart/')}">Explore Shop Demo</a><a class="secondary-btn" href="${url('gallery/')}">View Gallery</a></div>
    ...
    carousel(){return `<section class="section"><span class="pill">Carousel showcase</span><h1 class="section-title">Elegant slideshow for hero banners and promotions.</h1><div class="slideshow" data-carousel><article class="slide is-active"><div class="slide-content"><h2>Launch your business site</h2><p>Premium blue theme, strong hero, and direct call-to-action sections.</p><a class="primary-btn" href="${url('contact/')}">Contact Now</a></div><img src="${img('assets/images/slides/slide-growth.svg')}" alt="Business growth"></article><article class="slide"><div class="slide-content"><h2>Sell packages online</h2><p>Use the cart and dummy checkout flow to show a complete purchase experience.</p><a class="primary-btn" href="${url('shopping-cart/')}">Try Cart</a></div><img src="${img('assets/images/slides/slide-commerce.svg')}" alt="Commerce"></article><article class="slide"><div class="slide-content"><h2>Build instant trust</h2><p>Gallery, social links, map, chatbot, and WhatsApp make the site feel alive.</p><a class="primary-btn" href="${url('gallery/')}">View Gallery</a></div><img src="${img('assets/images/slides/slide-trust.svg')}" alt="Trust"></article><div class="carousel-controls"><button data-carousel-prev>‹</button><button data-carousel-next>›</button></div></div><div class="thumb-row" data-carousel-thumbs></div></section>`},
